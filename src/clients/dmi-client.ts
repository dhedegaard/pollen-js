...
interface ApiResponse extends z.infer<typeof apiResponseSchema> {}
...
export const createDmiClient = () => {
  const fetchData = async (): Promise<ApiResponse> => {
    return await fetch(APIURL, {
      ...
      .then((data: unknown) => apiResponseSchema.parseAsync(data))
  }
  ...
  async function fetchAndParse(): Promise<readonly ParsedXMLStructure[]> {
